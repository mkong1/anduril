/****************************************************************************************
 * Setups_X1R_2C1S.h - for the Eagle Eye X1R, 2 channels, 1S battery
 * =================  DEL 22mm thin driver, single LED
 *
 * Created: 12/22/2018 3:40 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 40				// Drop over rev. polarity protection diode: using 0.40V
