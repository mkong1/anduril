/****************************************************************************************
 * Setups_X9_2C1S.h - for the Amutorch X9, 2 channels, 1S battery
 * ================  DEL 20mm thin driver, triple 3V XHP50.2 LED
 *
 * Created: 03/24/2018 10:30 AM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 34				// Drop over rev. polarity protection diode: using 0.34V
...
//		-5  about right for the Amutorch X9 
...
#define DEFAULT_STEPDOWN_TEMP (75)	// default for stepdown temperature (50C=122F, 55C=131F)
