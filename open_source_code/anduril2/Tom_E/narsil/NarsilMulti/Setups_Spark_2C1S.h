/****************************************************************************************
 * Setups_Spark_2C1S.h - for the Spark SF6, 2 channels, 1S battery
 * ===================
 *
 * Created: 4/28/2018
 *  Author: Tom E
...
#define D1_DIODE 30				// Drop over rev. polarity protection diode: using 0.28V for Q8.
