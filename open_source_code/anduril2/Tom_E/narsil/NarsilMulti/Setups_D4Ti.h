/****************************************************************************************
 * Setups_D4Ti.h - for the Emisar D4Ti (Charlie), 2 channels, 1S battery
 * =============  IOS driver, quad XPL HI V2 5D
 *
 * Created: 12/29/2018 3:40 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define TEMP_CAL_OFFSET (-17)
//   -17  about right for the D4Ti (single)
