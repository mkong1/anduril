/****************************************************************************************
 * Setups_C20C#2_2C1S.h - for the Sunwayman C20C Tomahawk, 2 channels, 1S battery
 * ====================  DEL 17mm thin driver, triple LED
 *
 * Created: 11/24/2018 1:00 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 35				// Drop over rev. polarity protection diode: using 0.25V
