/****************************************************************************************
 * Setups_X6R_2C1S.h - for the Eagle Eyes X6R, 2 channels, 1S battery
 * =================
 *  NOTE: Did not use a D1 diode in this light
 * Created: 9/11/2018
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
...
#define D1_DIODE 6				// Drop over rev. polarity protection diode: using 0.28V for Q8.
										// Value is added to the reading: higher the #, higher it reads
										// the C8F was reading low at 0.28, approx. 0.06 added should be bout right
...
#else
 #define DEF_MOON_LEVEL		2		// 0..7, 0: disabled, usually set to 3 (350 mA) or 5 (380 mA) - 2 might work on a 350 mA
#endif
