/****************************************************************************************
 * Setups_JM70_2C1S.h - for the Amutorch JM70 , 2 channels, 1S battery
 * ==================
 *
 * Created: 4/14/2018 12:19 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 28				// 0.51V for SD Mini w/IOS driver (Drop over rev. polarity protection diode: using 0.28V for Q8)
										// this is pretty high - I replaced the diode with a std one, but still needs a high value
...
//#define ONBOARD_LED				// Disable/Enable the LED support
...
#endif
#define DEF_STEPDOWN_MODE	2		// 0=disabled, 1=thermal, 2=60s, 3=90s, 4=120s, 5=3min, 6=5min, 7=7min (3 mins is good for production)
...
#define DEF_LOCATOR_LED		0		// Locator LED feature (ON when light is OFF) - 1=enabled, 0=disabled
...
#define DEF_ONBOARD_LED		0		// On Board LED support - 1=enabled, 0=disabled
//----------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------
