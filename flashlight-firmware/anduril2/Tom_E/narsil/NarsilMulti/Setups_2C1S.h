/****************************************************************************************
 * Setups_2C1S.h - for generic use, 2 channels, 1S battery
 * =============
 *
...
#define D1_DIODE 24				// 0.51V for SD Mini w/IOS driver (Drop over rev. polarity protection diode: using 0.28V for Q8)
