/****************************************************************************************
 * Setups_2C2S.h - 2 channels, 2S batteries
 * =============
 *
...
#define TEMP_CAL_OFFSET (-10)
//	  -10 for the Haikelite MT07
//	  -12 for the Haikelite MT03
//   -11  Convoy L6
...
#define DEF_MODE_SET_IDX	5		// 0..11, mode set currently in effect, chosen by user (3=4 modes)
