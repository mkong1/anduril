/****************************************************************************************
 * Setups_ZY-T114_2C1S.h - for the ZY-T11 clone #4, 2 channels, 1S battery
 * =====================  CK driver for the Zy-T11, single LED
 *
 * Created: 01/27/2018 5:15 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 32				// Drop over rev. polarity protection diode: using 0.32V
