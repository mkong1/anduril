/****************************************************************************************
 * Setups_C20C_2C1S.h - for the Sunwayman C20C Tomahawk, 2 channels, 1S battery
 * ==================  kludgy driver, modded MtnE one
 *
 * Created: 11/18/2018 4:30 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 64				// Drop over rev. polarity protection diode: using 0.64V
