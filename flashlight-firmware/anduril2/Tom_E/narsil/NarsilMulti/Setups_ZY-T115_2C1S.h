/****************************************************************************************
 * Setups_ZY-T115_2C1S.h - for the ZY-T11 clone #5, 2 channels, 1S battery
 * =====================  CK driver for the ZY-T11, single LED
 *
 * Created: 02/24/2018 9:48 PM
 *  Author: Tom E
 ****************************************************************************************/
#ifndef SETTINGS_H_
#define SETTINGS_H_
...
#define D1_DIODE 30				// Drop over rev. polarity protection diode: using 0.30V
